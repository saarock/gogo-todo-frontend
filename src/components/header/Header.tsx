  ...
  return (
    <header className={`gogo__header ${theme.themeMode}`}>
      <nav className="gogo__header__nav" ref={nav}>
        <span className={`gogo__nav__menu`} onClick={hideShowNav}>{<TiThMenu/>}</span>
                    ...
                    {nav.children && (
                        <ul className="gogo__header__nav__child__navs" key={nav.name}>
                          ...
                          {nav.children.map((childNav) => (
                              <li className="gogo__header__nav__navs__child__navbar" key={childNav.name} onClick={

                                childNav.name === "dark Mode" ? lightTheme : childNav.name === "light Mode" ? darkTheme : undefined
