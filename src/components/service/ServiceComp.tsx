                ...
                <div className="gogo__row">
                    <div className="gogo__col-lg-6 gogo__align-self-center gogo__wow gogo__fadeInLeft">
                        <div className="gogo__left-image">
                            <img
                                src="/images/services-left-image.png"
                                alt="Services"
                            />
                        </div>
                    </div>
                    <div className="gogo__col-lg-6 gogo__wow gogo__fadeInRight">
                        <div className="gogo__section-heading">
                            ...
                            <p>
                                Space Dynamic HTML5 template is free to use for
                                your website projects. However, you are not
                                permitted to redistribute the template ZIP file
                                on any CSS template collection websites. Please
                                contact us for more information. Thank you for
