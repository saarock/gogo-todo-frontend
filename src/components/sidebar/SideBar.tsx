  ...
  return (
    ...
    >
            ...
            <h2 className="gogo__username">
              {isUserWantToChangeFullName && (
                <div className="gogo__change__input__container">
                  ...
                  />
                  <Button text="save" className="gogo__save__button" onClick={changeSave}/>
                </div>
              )}
              {user.isAuthenticated && user.user?.fullName}{" "}
              <span className="gogo__edit__icon" onClick={onClickEditButton}>
                <FaRegEdit />
              </span>
            </h2>
      ...
      <div className="gogo__side__nav__child">
        ...
        <div
          className="gogo__side__navbar__toggle"
          onClick={() => setResponsive(!responsive)}
        >
          <span>
            {responsive ? <FaCircleChevronRight /> : <FaChevronCircleLeft />}
          </span>
        </div>
      </div>
    </div>
