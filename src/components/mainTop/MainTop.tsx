              ...
              <div className="gogo-row">
                <div className="gogo-col-lg-6 gogo-align-self-center">
                  <div className="gogo-left-content header-text wow fadeInLeft">
                    ...
                    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Assumenda laudantium veritatis soluta
                      sint vta 2.
                      <br/>
                      Lorem ipsum dolor sit amet consectetur adipisicing elit. Et, labore! <a rel="nofollow"
                                                                                              href="https://templatemo.com/page/1"
                                                                                              target="_parent">GOGO</a>.
                    </p>
                    <form id="search" action="#" method="GET">
                      <fieldset>
                        <input type="address" name="address" className="gogo-email" placeholder="Search project...."
