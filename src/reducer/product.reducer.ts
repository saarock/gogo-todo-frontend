...
export interface ProductState {
  ...
  isUserWantToSeeOptions?: {productId? : number, isWantToSeeOptions?: boolean, isUserWantToUpdate?: boolean}
}
...
type Action =
  ...
  | {
    type: ProductActionTypes.IS_USER_WANT_TO_SEE_THE_OPTIONS_OF_THE_PRODUCT;
      payload: {productId? : number, isWantToSeeOptions?: boolean,isUserWantToUpdate?: boolean};
  };
